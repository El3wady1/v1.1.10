...
Future<void> createOrderProduction({
  ...
  try {
   ...
   await Active30minorderproductionservices.make();
  } catch (e) {
...
Future<bool> checkPendingOrders(String branchId) async {
  try {
    final url = Uri.parse(Apiendpoints.baseUrl + Apiendpoints.orderProduction.getOrderPof2Days);
...
var canedit;
var usercanedite;
OrderProductionBody({required this.canedit,required this.usercanedite});
  @override
...
product.quantity = newValue.toDouble();
  ...
  Widget _buildCurrentScreen() {
    switch (_currentIndex) {
      ...
      case 1:
        return Lastorderproductionview(role: "user", canedite: widget.canedit,usercanedite:widget.usercanedite ,);
      default:
        return _buildOrderProductionScreen();
    }
  }
...
class Product {
  ...
  factory Product.fromJson(Map<String, dynamic> json) {
    return Product(
      id: json['_id'].toString(),
      name: json['name'].toString(),
packSize: (json['packSize']?.toString() ?? "").isEmpty ? "" : json['packSize']?.toString() ?? "",
