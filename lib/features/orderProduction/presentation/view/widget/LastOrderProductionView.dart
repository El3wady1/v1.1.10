...
class Lastorderproductionview extends StatefulWidget {
  ...
  var usercanedite;
  var canedite;
  Lastorderproductionview({required this.role, required this.canedite,required this.usercanedite});
...
class ProductionItem {
  ...
  ProductionItem({
    ...
    required this.name,
    required String package, // تغيير إلى required بدون final
  ...
  }) : package = package.isEmpty ? "" : package, // تعيين القيمة الافتراضية
